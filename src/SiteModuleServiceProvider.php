...
class SiteModuleServiceProvider extends AddonServiceProvider
{
    ...
    protected $routes = [
        ...
        'admin/site/update-site/{siteID}' => 'Visiosoft\SiteModule\Http\Controller\Admin\SiteController@updateSite',
        ...
        'sh/updatesite' => 'Visiosoft\SiteModule\Http\Controller\SiteController@updateSite',
